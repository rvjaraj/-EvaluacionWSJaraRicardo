...
a persistence unit "EvaluacionWSJaraRicardoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSJaraRicardo\pom.xml":
...
artifact ("EvaluacionWSJaraRicardo.war") is already built. You can build
